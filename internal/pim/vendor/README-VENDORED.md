...
The following changes are applied across Tasks 1–4 of `docs/superpowers/plans/2026-05-14-pim.md`. All five core modifications (items 1–5) are now applied. To re-sync from upstream, re-apply these in order:
