...
func NewSubnetCommand() *cobra.Command {
	...
	updateCmd.Flags().String("network-security-group", "", "NSG resource ID, or name (assumed to be in the same resource group); empty string clears")
	updateCmd.Flags().String("route-table", "", "Route table resource ID, or name (assumed to be in the same resource group); empty string clears")
	updateCmd.Flags().String("nat-gateway", "", "NAT gateway resource ID, or name (assumed to be in the same resource group); empty string clears")
