...
func Create(ctx context.Context, cmd *cobra.Command, resourceGroup, vmName, name, location, script string, noWait bool) error {
	...
	poller, err := client.BeginCreateOrUpdate(ctx, resourceGroup, vmName, name, runCommand, nil)
	if err != nil {
