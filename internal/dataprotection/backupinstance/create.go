...
func newCreateCommand() *cobra.Command {
  cmd := &cobra.Command{
    ...
    RunE: func(cmd *cobra.Command, args []string) error {
      ...
      return CreateBackupInstance(context.Background(), cmd, resourceGroup, vaultName, backupInstanceFile, noWait)
    },
  }
...
func CreateBackupInstance(ctx context.Context, cmd *cobra.Command, resourceGroup, vaultName, backupInstanceFile string, noWait bool) error {
