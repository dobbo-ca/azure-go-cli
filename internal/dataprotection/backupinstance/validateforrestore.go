...
func newValidateForRestoreCommand() *cobra.Command {
  cmd := &cobra.Command{
    ...
    RunE: func(cmd *cobra.Command, args []string) error {
      ...
      return ValidateForRestore(context.Background(), cmd, resourceGroup, vaultName, backupInstanceName, restoreRequestFile, noWait)
    },
  }
...
func ValidateForRestore(ctx context.Context, cmd *cobra.Command, resourceGroup, vaultName, backupInstanceName, restoreRequestFile string, noWait bool) error {
