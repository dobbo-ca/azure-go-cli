...
func newShowCommand() *cobra.Command {
  cmd := &cobra.Command{
    ...
    RunE: func(cmd *cobra.Command, args []string) error {
      ...
      return ShowBackupPolicy(context.Background(), resourceGroup, vaultName, name)
    },
  }
...
func ShowBackupPolicy(ctx context.Context, resourceGroup, vaultName, name string) error {
